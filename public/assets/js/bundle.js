...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)(_reducers2.default, 'test', (0, _redux.applyMiddleware)(_reduxThunk2.default));

	(0, _reactDom.render)(_react2.default.createElement(_Root2.default, { store: store }), document.getElementById('quiz-component'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QuestionBoxContainer = __webpack_require__(182);

	var _QuestionBoxContainer2 = _interopRequireDefault(_QuestionBoxContainer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QuestionBox = __webpack_require__(186);
	...
	var QuestionBoxContainer = (0, _reactRedux.connect)(mapStateToProps)(_QuestionBox2.default);

	exports.default = QuestionBoxContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function loadNewQuestionAction(correctAnswer, randomOptions) {
	    return {
	...
	function loadNewQuestion() {
	    ...
	    var correctAnswer = getRandomCountry(allCountries);
	    var randomOptions = getRandomOptions(allCountries);

	    _index2.default.dispatch(loadNewQuestionAction(correctAnswer, randomOptions));
	}
	...
	function loadAllCountries() {
	    ...
	    return function (dispatch) {
	        (0, _isomorphicFetch2.default)('assets/countries.json').then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var actions = _interopRequireWildcard(_common);
	...
	var QuestionBox = function (_Component) {
	    _inherits(QuestionBox, _Component);

	    function QuestionBox(props) {
	        _classCallCheck(this, QuestionBox);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(QuestionBox).call(this, props));
	    }

	    _createClass(QuestionBox, [{
	        key: 'isAnswerSelected',
	        value: function isAnswerSelected() {
	        ...
	        value: function render() {
	            ...
	            var correctAnswerCount = _props.correctAnswerCount;
	            var incorrectAnswerCount = _props.incorrectAnswerCount;


	            var buttonStatus = this.isAnswerSelected();
	                                ...
	                                options.map(function (option, i) {
	                                    return _react2.default.createElement(
	                                        ...
	                                        _react2.default.createElement(
	                                            ...
	                                            _react2.default.createElement(
	                                                'button',
	                                                { key: i, className: 'btn btn-primary btn-block', onClick: actions.selectAnswer.bind(this, option.option) },
	                                                option.option
	                                            )
	                                        )
	                                    );
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        'div',
	                                        { className: 'progress' },
	                                        _react2.default.createElement('div', { className: 'progress-bar', style: { width: '70%' } })
	                                    )
	                                )
	                            )
	                        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Start = (_dec = (0, _reactRedux.connect)(mapStateToProps), _dec(_class = function (_Component) {
	    ...
	    function Start(props) {
	        ...
	        _this.props.dispatch(common.loadAllCountries());
	        return _this;
	    }
	    ...
	    _createClass(Start, [{
	        key: 'render',
	        value: function render() {
	            var applicationStarted = this.props.applicationStarted;


	            if (applicationStarted) {
	                return _react2.default.createElement(_QuestionBoxContainer2.default, null);
	            } else {
	                return _react2.default.createElement(
	                    'button',
	                    { className: 'btn btn-primary', onClick: function onClick() {
	                            return common.startApplicationAndLoadQuestion();
	                        } },
